...
/* redirect if on netlify frontend */
if (window.location.hostname == "its-backend.netlify.app" && window.location.hash == "") {
  window.location.href = 'https://www.itsteramo.it/orientamento-21-23/'; 
}